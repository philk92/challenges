...
function updateScore() {
  ...
  if (scoreOne == selection.value) {
    ...
    scoreTwoText.classList.add("text-danger");
  } else if (scoreTwo == selection.value) {
    buttonOne.disabled = true;
    buttonTwo.disabled = true;
    scoreOneText.classList.add("text-danger");
...
function resetScore() {
  ...
  scoreOneText.classList.remove("text-success", "text-danger");
  scoreTwoText.classList.remove("text-success", "text-danger");
}
